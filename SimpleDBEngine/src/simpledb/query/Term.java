...
public class Term {
    ...
    * evaluate to constants that satisfy the predicate,
    * with respect to the specified scan.
    * @param s the scan
    * @return true if both expressions have the values in the scan that satisfy the predicate
    */
   public boolean isSatisfied(Scan s) {
      Constant lhsval = lhs.evaluate(s);
      Constant rhsval = rhs.evaluate(s);
      return operator.evaluate(lhsval, rhsval);
   }
